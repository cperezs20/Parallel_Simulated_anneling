...
# Define the rotation matrix. This matrix represents the relative directives to predict the location of CA
# in a lattice.
def rotation_matrix(alfa):
    return np.matrix([[round(math.cos(alfa)),     round(-math.sin(alfa))],
